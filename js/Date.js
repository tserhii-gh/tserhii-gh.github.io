...
Date.monthNames = new Array('Января','Февраля','Марта','Апреля','Мая','Июня','Июля','Августа','Сентября','Октября','Ноября','Декабря');
// Month abbreviations. Change this for local month names
Date.monthAbbreviations = new Array('Янв','Фев','Мар','Апр','Мая','Июн','Июл','Авг','Сент','Окт','Нояб','Дек');
...
Date.convert = function(input)
{
    var string = Date.parseString(input,'yyyy-MM-dd');
    string = new Date(string).format('MMM dd, yyyy');
    return string;
};

Date.datediff = function (fromDate, toDate, interval) {
